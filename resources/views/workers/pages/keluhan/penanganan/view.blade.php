...
<div class="page-breadcrumb mt-n5 ms-n4 mb-3">
    <div class="row">
        <div class="col-7 align-self-center">
            <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Detail Laporan Keluhan
            </h4>
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        ...
                        <li class="breadcrumb-item text-muted active" aria-current="page">Detail Laporan
                            Keluhan</li>
                    </ol>
                </nav>
            </div>
                ...
                <form class="row gy-4" method="" action="" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 d-flex align-items-start">
                        <div class="row d-flex col-12">
                            ...
                            <div class="col-sm-0 col-md-0 col-lg-7">
                                <h5>{{$asg->complain->created_at}} WIB</h5>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12 my-2">
                                <div class="form-group">
                                    <textarea name="description"
                                        ...
                                        placeholder="Masukkan Deskripsi Keluhan" cols="30" rows="10">{{$asg->complain->complain_description}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 d-flex align-items-start">
                        <div class="row d-flex col-12">
                            ...
                            <div class="col-sm-0 col-md-0 col-lg-7">
                                <h5>{{$asg->complain->status->name}}</h5>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-0 col-md-0 col-lg-7">
                                <h5>
                                    @if(!is_null($asg->submissions))
                                        @if($asg->submissions->submission_status == 2)
                                            Selesai
                                        @else
                                            Proses
                                        @endif
                    ...
                    @if(!is_null($asg->submissions) && $asg->submissions->submission_status == 2)
                    <div class="col-sm-12 col-md-12 col-lg-12 d-flex align-items-start">
                        <div class="row d-flex col-12">
                            <div class="col-sm-6 col-md-6 col-lg-4">
