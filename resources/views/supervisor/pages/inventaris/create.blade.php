                ...
                <form action="">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="form-group">
                            <textarea class="form-control" rows="4" type="text" id="input" placeholder="Deskripsi alat"></textarea>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label class="col-sm-2 col-form-label" style="color: #5F76E8;">Total</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="input" placeholder="> 0">
                        </div>
                    </div>
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a href="{{ route('supervisorInventaris') }}" type="submit" style="border-radius: 14px;" class="px-3 btn btn-primary">Tambahkan</a>
