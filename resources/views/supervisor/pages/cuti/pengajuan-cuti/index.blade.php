                                    ...
                                    <tr>
                                        @foreach ($data as $request)
                                            <tr>
                                                ...
                                                <td>
                                                    {{-- <div class="actions">
                                                        <a href="{{ route('lihat_detail', $request->id) }}" id="suspendd" data-toggle="modal"
                                                            data-target="#detail{{ $request->id }}"
                                                            class="btn btn-sm bg-danger-light">Lihat</a>
                                                    </div> --}}
                                                    <button type="button" class=" btn border-0" data-bs-toggle="modal" data-bs-target="#detail{{$request->id}}">
                                            ...
                                            {{-- Start Modal --}}
                                            <div class="modal fade" id="detail{{$request->id}}"  value="{{$request->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="">
                                                                <div class="mb-3 row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <input type="text" class="form-control disable" id="idCuti" value="CT00{{$request->id}}" placeholder="Nama Lengkap" disabled>
                                                                    </div>
                                                                </div>
                                                                <div class="mb-3 row">
                                                                    <label for="tanggalPengajuan" class="col-sm-4 col-form-label">Pengajuan</label>
                                                                    <div class="col-sm-8">
                                                                    <input type="date" class="form-control" id="idCuti" value="{{$request->created_at->format('Y-m-d')}}" disabled>
                                                                    </div>
                                                                </div>
                                                                <div class="mb-3 row">
                                                                    <label for="fullName" class="col-sm-4 col-form-label">Nama Lengkap</label>
                                                                    <div class="col-sm-8">
                                                                    <input type="text" class="form-control" id="fullName" value="{{$request->user->name}}" disabled>
                                                                    </div>
                                                                </div>
                                                                <div class="mb-3 row">
                                                                    <label for="jobPosition" class="col-sm-4 col-form-label">Posisi</label>
                                                                    <div class="col-sm-8">
                                                                    <input type="text" class="form-control" id="jobPosition" value="{{$request->user->user_role}}" disabled>
                                                                    </div>
                                                                </div>
                                                                <div class="mb-3 row">
                                                                ...
                                                                <div class="mb-3 row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                    <input type="date" class="form-control" id="tanggalMulai" value="{{$request->start_date}}" disabled>
                                                                    </div>
                                                                </div>
                                                                <div class="mb-3 row">
                                                                    <label for="tanggalAkhir" class="col-sm-4 col-form-label">Tanggal Akhir Cuti</label>
                                                                    <div class="col-sm-8">
                                                                    <input type="date" class="form-control" id="tanggalAkhir" value="{{$request->end_date}}" disabled>
                                                                    </div>
                                                                </div>
                                                                <div class="mb-4 row">
                                                                    <label for="pesanCuti" class="col-sm-4 col-form-label">Pesan</label>
                                                                    <div class="col-sm-8">
                                                                        <textarea class="form-control" rows="7" id="pesanCuti" disabled>{{$request->message}}</textarea>
                                                                    </div>
                                                                </div>
